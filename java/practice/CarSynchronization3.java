class Car3 implements Runnable{
     public  void run(){    //   if we make this method synchronized the one thread will be thier inside at a time no oter thread will accessing this method if one is already thier
        try{
...
public class CarSynchronization3 {
