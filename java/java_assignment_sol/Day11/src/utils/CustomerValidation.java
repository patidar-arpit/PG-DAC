...
public class CustomerValidation {
   ...
   public static Customer validateAllInput(String fullName, String email, String password, double registrationAmount, String dob,String plan,String lastSubDate,List<Customer> customList) throws CustomerException {
