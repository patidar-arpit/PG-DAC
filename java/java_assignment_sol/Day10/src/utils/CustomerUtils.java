...
public class CustomerUtils {
	...
	public static List<Customer> sampleData() {
	    ...
	    cl.add(new Customer("Arpit","arpit@123","arpit200",10000,LocalDate.parse("2023-10-10"),ServicePlan.GOLD));
	    cl.add(new Customer("Bittu","bittu@123","bittu200",3000,LocalDate.parse("2000-10-10"),ServicePlan.GOLD));
	    cl.add(new Customer("ABCD","ABCD@123","ABCD200",5000,LocalDate.parse("2005-10-10"),ServicePlan.DIAMOND));
	    cl.add(new Customer("pqr","pqrpit@123","pqr200",15000,LocalDate.parse("2010-10-10"),ServicePlan.GOLD));
